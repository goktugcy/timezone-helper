...
const localTime = (0, timeConversion_1.convertToUserTimezone)(utcTime, userTimezone);
console.log('Local Time:', localTime);
// Example 2: Format time in a specific format
const formattedTime = (0, timeConversion_1.formatTime)(utcTime, userTimezone, 'YYYY-MM-DD HH:mm');
console.log('Formatted Time:', formattedTime);
// Example 3: Format the current date in a specific format
const currentDate = new Date();
const customFormat = 'YYYY-MM-DD';
const formattedDate = (0, timeFormat_1.formatDate)(currentDate, customFormat);
console.log('Formatted Date:', formattedDate);
// Example 4: Return the current date in ISO 8601 format
const isoString = (0, timeFormat_1.toISOString)(currentDate);
console.log('ISO String:', isoString);
// Example 5: Return the current date and time in a human-readable format
const readableNow = (0, timeFormat_1.nowFormatted)();
